...
/**
 * Fetch DM relays for a given pubkey from their kind 10050 event.
 * Falls back to configured relays if no DM relay list is found.
 */
 ...
 * If no relays are provided, uses configured relays.
 */
